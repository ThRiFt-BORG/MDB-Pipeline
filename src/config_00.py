...
# -- Shapefile (MDB boundary) ------------------------------------------------
# Place MDB_Basin.gpkg in data/raw/ OR update this path
MDB_SHAPEFILE = RAW / "MDB_Basin.gpkg"
...
# -- MDB bounding box (coarse fallback; real boundary from MDB_SHAPEFILE) ----
